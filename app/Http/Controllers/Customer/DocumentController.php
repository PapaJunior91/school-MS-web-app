...
use App\Http\Requests\Customer\Document\AddValidation;
use App\Http\Requests\Customer\Document\EditValidation;
...
{
    protected $base_route = 'customer.document';
    protected $view_path = 'customer.document';
